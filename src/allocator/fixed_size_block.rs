        ...
        match list_index(&layout) {
            Some(index) => match allocator.list_heads[index].take() {
                ...
                None => {
                    ...
                    let block_algin = block_size;
                    let layout = Layout::from_size_align(block_size, block_algin).unwrap();
    ...
    unsafe fn dealloc(&self, ptr: *mut u8, layout: Layout) {
        ...
        match list_index(&layout) {
            Some(index) => {
                ...
                //verify that block size and alignment are correct
